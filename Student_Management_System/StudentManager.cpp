...
void addNewStudent() {
    ...
    while (true) {
        ...
        if (a <= 0 || a > 8) {
            ...
            cout << "Please input valid Semester (1-8)\n" << endl;
            continue;
        }
    ...
    while (true) {
        ...
        if (a < 0.0 || a > 4.00) {
            SetConsoleTextAttribute(hConsole, 4);
            cout << "Please input valid CGPA (0.0-4.0)\n" << endl;
            continue;
        }
...
void modifyStudent() {
    ...
    fstream fio;
    fio.open("record.csv", ios::in | ios::out | ios::binary);
    if (!fio.is_open()) {
        SetConsoleTextAttribute(hConsole, 4);
        cout << "\n\tFile Unable To Open\n" << endl;
        SetConsoleTextAttribute(hConsole, 2);
...
void deleteStudent() {
    ...
    fin.open("record.csv", ios::binary);
    fout.open("temp.csv", ios::binary);
...
void writeToFile() {
    ofstream fout;
    fout.open("record.csv", ios::app | ios::binary);
...
void loginWindow() {
    ...
    ifstream fin;
    fin.open("Log_In_Record.csv", ios::binary);
    ...
    if (fin.is_open()) {
        ...
        cout << "Log In Error. No records found. Please Register.\n" << endl;
    }
    SetConsoleTextAttribute(hConsole, 10);
...
void ResisterWindow() {
    ...
    heading(1);
    cout << "---------------------------" << endl;
    cout << "ADMIN REGISTER PAGE" << endl;
    cout << "---------------------------" << endl;

    SetConsoleTextAttribute(hConsole, 4);
    ofstream fout;
    fout.open("Log_In_Record.csv", ios::app | ios::binary);
